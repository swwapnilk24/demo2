...
export PerformanceManagement, { schema } from './model'

const router = new Router()
const { goalSettingScreen, goalApproval, appraisals, appraiser, normalisationProcess, positionAndRoles } = schema.tree
 ...
 */
router.post('/',
  body({ goalSettingScreen, goalApproval, appraisals, appraiser, normalisationProcess, positionAndRoles }),
  create)
