...
export ShortTermIncentives, { schema } from './model'

const router = new Router()
const { employeeid, ipf, bpf, cpf, amount, abs, beginDate, endDate, caldays, fte, stitarget, performance_year } = schema.tree
 ...
 */
router.post('/',
    body({ employeeid, ipf, bpf, cpf, amount, abs, beginDate, endDate, caldays, fte, stitarget, performance_year }),
    create)
