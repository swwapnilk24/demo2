...
import { create, index, show, update, destroy, showSpecificYearResults } from './controller'
import { schema } from './model'
export MeritGuideLines, { schema } from './model'

const router = new Router()
const { band, min, mid, max, performance_year } = schema.tree
 ...
 */
router.post('/',
    body({ band, min, mid, max, performance_year }),
    create)
...
router.get('/:performance_year', showSpecificYearResults)    
