...
export CompensationPlanning, { schema } from './model'

const router = new Router()
const { performance_year, status, objective, behaviour, employeeid, reviewrating, prerating, currencycode, currentsalary, increasedate, compratio, merit, lumpsum, adjustment, promotion, paygrade, effectivedate, ltAmount, sti, target, employee } = schema.tree
 ...
 */
router.post('/',
  body({ employeeid, status, objective, behaviour, performance_year, reviewrating, prerating, currencycode, currentsalary, increasedate, compratio, merit, lumpsum, adjustment, promotion, paygrade, effectivedate, ltAmount, sti, target, employee }),
  create)
